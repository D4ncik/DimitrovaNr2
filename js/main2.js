...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const dropdowns = navLinks.querySelectorAll('.has-dropdown > a');
    ...
    // Toggle dropdown la click pe mobil (nivel 1 și 2)
    ...
    // Pentru sub-submeniuri (nivel 2) - corectat pentru mobil
    ...
    // Funcționalitate carusel oferte
    ...
    // Pornește autoplay-ul
    startAutoplay();
    
    // Oprește autoplay-ul când utilizatorul interacționează cu caruselul
    carousel.addEventListener('mouseenter', stopAutoplay);
    carousel.addEventListener('mouseleave', startAutoplay);
    
    // Actualizează poziția caruselului la redimensionarea ferestrei
    window.addEventListener('resize', () => {
        const newCardWidth = cards[0].offsetWidth;
        carousel.style.transform = `translateX(-${currentIndex * newCardWidth}px)`;
    });

    // Dropdown Simptome (acordeon orizontal la hover cu animatie)
    ...
    if (symptomsTab && symptomsDropdown) {
        ...
        // Verifică dacă există modale deschise
        ...
        // Funcție pentru deschiderea dropdown-ului
        ...
        // Funcție pentru închiderea dropdown-ului
        ...
        // Adăugăm event listeners pentru hover
        ...
        // Adăugăm un event listener pentru click în afara dropdown-ului
